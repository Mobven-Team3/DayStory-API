...
public class DayStoryAPIDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<User>().HasData(
            ...
            new User { Id = 2, FirstName = "Nisa", LastName = "Turhan", Username = "nisatur", Email = "nisa@gmail.com", HashedPassword = "AQAAAAIAAYagAAAAEEbO/nyiGYmwOTIe8lSZOx5V0fA3uJCJoajax2zFl9ZSSMbM10M27yrBbwzUPCc6gg==", BirthDate = "24-03-1999", Role = "User", Gender = Common.Enums.Gender.Female, CreatedOn = DateTime.UtcNow }
        );
    }
}
